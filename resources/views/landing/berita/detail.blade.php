...
@section('content')
    <style>
        ...
        .carousel-control-next {
            ...
            opacity: 0;
            /* Panah menghilang ketika tidak didekati */
        }
    ...
    <section id="detail" class="py-5">
        <div class="container col-xxl-8">
            ...
            <div class="text-center mb-4">
                <img src="{{ asset($berita->foto) }}" class="img-fluid rounded shadow" alt="{{ $berita->judul }}"
                    style="max-height: 100000000px; object-fit: cover;">
            </div>

            <!-- Berita Content -->
            <div class="konten-berita">
                <p class="text-muted mb-3"><i class="far fa-calendar-alt"></i> {{ $berita->created_at->format('d M Y') }}
                </p>
    ...
    <section class="pb-5 position-relative mx-n3" id="berita">
        <div class="container py-5">
            <hr style="background-color: black" class="mb-5">
                            ...
                            <div class="row py-5">
                                @foreach ($beritaChunk as $berita)
                                    <div class="col-lg-4 mb-4">
                                        <div class="card border-0 shadow-sm h-100 hovered-effect d-flex flex-column">
                                            ...
                                            <div class="card-body d-flex flex-column">
                                                <p class="text-muted small mb-2">{{ $berita->created_at->format('d M Y') }}
                                                </p>
                                                <h5 class="fw-bold mb-3">{{ $berita->judul }}</h5>
                                                <div class="mt-auto">
                                                    <a href="/detail/{{ $berita->slug }}"
                                                        class="text-decoration-none text-danger text-center fw-bold">
                                                        Ke Halaman >>
                                                    </a>
                                                </div>
                                            </div>

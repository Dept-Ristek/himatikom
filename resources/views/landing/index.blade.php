...
@section('content')
  ...
  .svg-container {
    display: flex;
    justify-content: center;  /* Agar elemen SVG berada di tengah secara horizontal */
    align-items: center;      /* Agar elemen SVG berada di tengah secara vertikal */
}
.card-body h4 {
    padding: 0.5rem 0; /* Atur padding untuk judul */
}

.card-body p {
    padding: 0.5rem 0; /* Atur padding untuk paragraf deskripsi */
}
        ...
        <section class="my-5">
            <div class="container">
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-5 ms-auto mt-lg-0 mt-4 mb-4 hovered-effect">
                            <div class="card shadow-xl h-100 px-3 py-3 outline"> <!-- Ubah padding disini -->
                                <div class="card-body text-center">
                                    <div class="svg-container">
                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="88" height="88" x="0" y="0"
                                        viewBox="0 0 256 256" style="enable-background:new 0 0 88 88" xml:space="preserve"
                                    ...
                                    <p class="text-center text-secondary hidden-text">
                        ...
                        <div class="col-12 col-lg-5 ms-auto mt-lg-0 mt-4 mb-4 hovered-effect">
                            <div class="card shadow-xl h-100 px-3 py-3 outline"> <!-- Ubah padding disini -->
                                <div class="card-body text-center">
                                    <div class="svg-container">
                                        <svg class="d-block d-sm-none" xmlns="http://www.w3.org/2000/svg" version="1.1"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="88" height="88" x="0"
                                        y="0" viewBox="0 0 511.998 511" style="enable-background:new 0 0 88 88"
                                        xml:space="preserve">
                                        <g>
                                            <path fill="#ffd86e"
                                    ...
                                    <div class="svg-container">
                                        <svg class="d-none d-sm-block " xmlns="http://www.w3.org/2000/svg" version="1.1"
                                    ...
                                    <p class="text-center text-secondary hidden-text">
                                        Program Studi Teknologi Rekayasa Perangkat Lunak dirancang lulusannya memiliki kemampuan dibidang
                                        kecerdasan buatan.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="card shadow-xl h-100 px-3 py-3 outline"> <!-- Ubah padding disini -->
                                <div class="card-body text-center">
                                    <div class="svg-container">
                                        <svg class="d-block d-sm-none" xmlns="http://www.w3.org/2000/svg" version="1.1"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="88" height="88" x="0"
                                        y="0" viewBox="0 0 96 96" style="enable-background:new 0 0 88 88"
                                        xml:space="preserve">
                                        <g>
                                            <path fill="#d9b18c"
                            ...
                            <div class="card shadow-xl h-100 px-3 py-3 outline"> <!-- Ubah padding disini -->
                                <div class="card-body text-center">
                                    ...
                                    <div class="svg-container">
                                        <svg class="d-block d-sm-none" xmlns="http://www.w3.org/2000/svg" version="1.1"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="88" height="88" x="0"
                                        y="0" viewBox="0 0 128 128" style="enable-background:new 0 0 88 88"
                                        xml:space="preserve">
                                        <g>
                                            <path fill="#ffdb80"
                                                d="M124 108v14.01a1.997 1.997 0 0 1-2 1.99H96.25a2.274 2.274 0 0 1-2.25-2.06V108zM94 88h30v16H94zM94 68v16h30V68zm17 10h-4a2 2 0 0 1 0-4h4a2 2 0 0 1 0 4z"
